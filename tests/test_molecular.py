...
from src.experiments.molecular.model import GCNLapPE, GINLapPE
...
class TestGCNLapPEForward:
    """Forward pass shape and gradient tests for GCNLapPE."""
...
class TestGCNLapPEPermutationInvariance:
    """Permuting nodes within a graph should give the same graph-level output."""
